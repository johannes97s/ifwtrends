...
#'
#' [forecast_q()] uses quarterly vintages generated by [roll()]
#' to predict the value of another time series for the next quarter
...
#' @param data A tibble with some data
#' you want to predict for the next quarter
