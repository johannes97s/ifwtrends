...
#' @description
#'
#' [forecast_q()] uses quarterly vintages generated by [roll()] to predict the
...
#' @param data A tibble with some data you want to predict for the next quarter
#'   that is somewhat correlated with the data in r_list.
#' @param fd A logical value to indicate if you want to use the first
